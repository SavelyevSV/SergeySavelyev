...
class TestRegistryTask(TestCaseUI):
    ...
    def test_move_task(self):
        ...
        if letter_count.isdigit():
            ...
            letter_count = 0
        self.page.messages.should_be(Visible)
        ...
        self.page.message_folders.should_be(Visible)
    ...
    def test_check_date(self):
        ...
        self.page.chat_list.should_be(Visible)
    ...
    def test_check_tag(self):
        ...
        self.page.tags_folder.should_be(Visible)
