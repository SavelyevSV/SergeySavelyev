...
def repeats(our_str):
    """
    Функция repeats, которая принимает на вход строку our_str, смотрит, сколько раз каждый
    символ уже встречался, и добавляет количество к символам с помощью постфикса формата _n
    @param our_str:
    @return new_str:
    """
