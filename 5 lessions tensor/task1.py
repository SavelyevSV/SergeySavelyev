...
def letter_stat(our_str):
    """
    Функция letter_stat, которая на вход принимает строку our_str и возращает словарь letters_dict,
    где в качестве ключей буквы строки, а значениями являются числа, соответствующие количеству вхождений
