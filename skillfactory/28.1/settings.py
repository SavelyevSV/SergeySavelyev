class Settings:
    ...
    valid_email = 'XXXXXXXX@mail.ru'       # Ввести валидный email
    valid_password = 'XXXXXXXX'   # Ввести валидный пароль
    valid_email_reg = 'XXXXXXXX@mail.ru'   # Ввести валидный email
